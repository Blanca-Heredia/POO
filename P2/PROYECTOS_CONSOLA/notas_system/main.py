from usuarios.usuario import Usuarios as usuario
from notas.nota import Notas as nota
import getpass
...
class App:
  ...
  def menu_principal():
    while True:    
        borrarPantalla()
        print("""
      .::  Menu Principal ::. 1.- Registro 2.- Login 3.- Salir 
          """)
        ...
        if opcion == '1' or opcion=="REGISTRO":
            ...
            if registro:
                usuario_id, nombre, apellidos = registro[0], registro[1], registro[2]
                App.menu_notas(usuario_id, nombre, apellidos)
            else:
