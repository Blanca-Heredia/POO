...
class Vistas:
    ...
    def datos(self,tipo,ventana):
        ...
        btnregre=Button(ventana,text="Regresar",command=lambda: self.menu(ventana))
        btnregre.pack(pady=5)
           
    def consultar(self,ventana,tipo):
        self.borrarPantalla(ventana)
        lblTitulo=Label(ventana,text="Autos")
        ...
        lblNote.pack(pady=5)
        btnreg=Button(ventana,text="Regresar",command=lambda: self.menu(ventana))
        btnreg.pack(pady=5)
    ...
    def actualizar(self,tipo,ventana):
        ...
        btnen.pack(pady=7)
        btnregr = Button(ventana, text="Regresar", command=lambda:self.menu(ventana))
        btnregr.pack()
    ...
    def borrar(self,ventana,tipo):
        ...
        btnVolver=Button(ventana,text="Regresar",command= lambda: self.menu(ventana))
